...
import com.justjellystudios.android.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // Moves to the first element and gets the key
        if(results.moveToFirst()){
            rowID = results.getLong(0);
        }
        else {
            // Failure to move means the location does not exist, so we add it.
            ...
            Uri locationUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, newLocation);
    ...
    private Void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // add to database
            if ( cVVector.size() > 0 ) {
                ContentValues[] insertions = cVVector.toArray(new ContentValues[cVVector.size()]);
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Log.e(LOG_TAG , "Error in JSON parse");
        }finally {
