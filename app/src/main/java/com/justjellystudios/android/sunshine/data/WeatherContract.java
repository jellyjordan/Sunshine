...
public class WeatherContract {
    public static final String CONTENT_AUTHORITY = "com.justjellystudios.android.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // Location settings is used by api to make call for weather data.
        public static final String COLUMN_LOCATION_SETTING = "location_settings";

        // City name of location
        public static final String COLUMN_CITY_NAME = "city_name";

        // Pure Location information of weather data
