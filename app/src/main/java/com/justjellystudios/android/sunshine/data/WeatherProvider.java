...
public class WeatherProvider extends ContentProvider {
    ...
    /**
     * Determines the type of data needed based off the URI
     */
    @Override
    ...
    public int update(
        ...
        switch (sUriMatcher.match(uri)){
            case WEATHER:
                rows = database.update(WeatherContract.WeatherEntry.TABLE_NAME ,
                        values,
                        selection,
                        selectionArgs);
                break;
            case LOCATION:
                rows = database.update(WeatherContract.LocationEntry.TABLE_NAME ,
                        values,
                        selection,
                        selectionArgs);
                break;
